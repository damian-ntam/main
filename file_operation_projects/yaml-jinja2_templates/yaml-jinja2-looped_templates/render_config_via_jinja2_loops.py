...
template_dir = r"C:\Users\melih\PycharmProjects\main\\file_operation_projects\yaml-jinja2_templates\yaml-jinja2-looped_templates"
...
for device,config in yaml_data['dc1'].items():
  ...
  with open("generated_config.txt", "a") as file:
    file.write("\n")
    file.write("Adding device config for "+device)
    file.write("\n")
